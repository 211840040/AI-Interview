  ...
  return (
    ...
    >
      ...
      >
        {/* 渐变边框效果 */}
        <div
          className={`absolute inset-0 rounded-2xl p-[2px] bg-gradient-to-r from-emerald-200 via-teal-200 to-emerald-200 -z-10
            ${dragOver ? 'from-emerald-400 via-teal-400 to-emerald-400' : ''}`}
        >
